...
F.Dubois, \emph{Reconstruction des images tomographiques par rétroprojection filtrée}, CHU Saint Etienne, Revue de l'ACOMEN, vol 4, numéro 2 \hskip 1em plus
...
\bibitem{IEEEhowto:kopka}
Isabelle BLOCH, \emph{Reconstruction d'images de tomographie}, Télécom ParisTech \hskip 1em plus
  0.5em minus 0.4em\relax France (\url{Isabelle.Bloch@enst.fr})
\bibitem{IEEEhowto:kopka}
Pol Grasland-Mongrain, \emph{Le principe de la tomographie}\hskip 1em plus
...
\bibitem{IEEEhowto:kopka}
Irène Buvat, \emph{Reconstruction tomographique}\hskip 1em plus
  0.5em minus 0.4em\relax France : Mars 2011, (\url{file:///C:/Users/Pierre-Arnaud/Downloads/DESMNRecon_2011.pdf})
\bibitem{IEEEhowto:kopka}
L.Desbat, \emph{Le scanner médical, la tomographie}\hskip 1em plus
  0.5em minus 0.4em\relax TIMC-IMAG, UJF : 2004
\bibitem{IEEEhowto:kopka}
Matteo Frigo, Steven G.Johnson, \emph{FFTW}, version 3.3.6-pl1 \hskip 1em plus
  0.5em minus 0.4em\relax 15 Janv. 2017 (\url{http://www.fftw.org/fftw3.pdf})
\bibitem{IEEEhowto:kopka}
Pham Trong Tôn, tuteur : Dr.Nguyen Dinh Thuc, \emph{La transformation de Radon et son application en traitement de la radiographie pulmonaire} \hskip 1em plus
  0.5em minus 0.4em\relax Ho Chi Minh ville, Vietman : Juillet 2004
\bibitem{IEEEhowto:kopka}
Irène Buvat, \emph{Rétroprojection filtrée et reconstruction itérative}, U494 INSERM, Paris \hskip 1em plus
